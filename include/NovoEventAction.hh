...
class NovoEventAction : public G4UserEventAction
{
	public:
		...
		inline std::vector<G4double> &GetOpticalPhotonHitPosXs(){return fOpticalPhotonHitPosXs; }
		inline std::vector<G4double> &GetOpticalPhotonHitPosYs(){return fOpticalPhotonHitPosYs; }
		inline std::vector<G4double> &GetOpticalPhotonHitPosZs(){return fOpticalPhotonHitPosZs; }
		...
		inline std::vector<G4int> &GetElectronCount(){return fScintElectronCount; }
	...
	private:
		...
		std::vector<G4int> fScintElectronCount; // array of names corresponding to coordinates HitPosX,Y,Z
		std::vector<G4int> fScintOpticalPhotonCount; // array of names corresponding to coordinates HitPosX,Y,Z
		std::vector<G4double> fOpticalPhotonTheta; // array of names corresponding to coordinates HitPosX,Y,Z
		std::vector<G4double> fOpticalPhotonPhi; // array of names corresponding to coordinates HitPosX,Y,Z
