/// \file NovoUserEventInformation.hh
/// \brief Definition of the NovoUserEventInformation class
//
#include "G4VUserEventInformation.hh"
#include "G4ThreeVector.hh"
#include "globals.hh"

#ifndef NovoUserEventInformation_h
#define NovoUserEventInformation_h 1

class NovoUserEventInformation : public G4VUserEventInformation
{
	public:
		NovoUserEventInformation();
		virtual ~NovoUserEventInformation();
